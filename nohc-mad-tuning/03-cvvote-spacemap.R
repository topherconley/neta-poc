...
tmap <- expand.grid(lam1 = seq(sqrt(130), sqrt(140), length = 3)^2,
                    lam2 = seq(30, 39, length = 5),
                    lam3 = seq(sqrt(20), sqrt(60), length = 10)^2)

#result directory
respath <- "/home/cconley/scratch-data/neta-poc/nohc-mad-tuning/03"
...
save.image(file = file.path(respath, "poc-spacemap-03.rda"))
stopCluster(cl)
