...
fy <- "poc-prot-eset-dropout-nohcprot-std.rds"
...
#GRID
tmap <- expand.grid(lam1 = exp(seq(log(50), log(150), length = 50)))

#result directory
respath <- "/home/cconley/scratch-data/neta-poc/pnnl-mad-tuning/03"
