...
#SBATCH -o /home/cconley/scratch-data/neta-poc/mrna-tuning/05/log.out
#SBATCH -e /home/cconley/scratch-data/neta-poc/mrna-tuning/05/log.err
...
/usr/bin/R --no-save --no-restore --no-site-file --no-init-file --args 31 < /home/cconley/repos/neta-poc/mrna-tuning/05-cvvote-spacemap.R
