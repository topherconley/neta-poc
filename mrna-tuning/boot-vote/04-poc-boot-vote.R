...
if (comp == "gauss") {
  ...
  library(doParallel)
  nodelist <- getnodelist(maxpernode=ncores, f = "nodelist_04.txt")
  print(nodelist)
...
tune <- list(lam1 = 135, lam2 = 35, lam3 = 50.5) 
...
#result directory
respath <- "/home/cconley/scratch-data/neta-poc/mrna-boot-vote/04"
