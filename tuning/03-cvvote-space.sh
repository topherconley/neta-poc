...
#SBATCH -o /home/cconley/scratch-data/neta-poc/tuning/03/log.out
#SBATCH -e /home/cconley/scratch-data/neta-poc/tuning/03/log.err
...
/usr/bin/R --no-save --no-restore --no-site-file --no-init-file --args 15 < /home/cconley/repos/neta-poc/tuning/03-cvvote-space.R
